...
# Usage: python3 train.py --dir=dataset/activity-recognition/sensor-data/ \
#        --type=cnn --epochs 30 --batch 16 --save_best=True
import argparse
...
from utils.common import (CategoryNames, load_dataset, reshape_data,
                          save_model, stats_evaluation, str2bool)
